...
class Solution(object):
    def mostBooked(self, n, meetings):
        ...
        free_rooms = list(range(n))  # All rooms initially free
        ...
        for start, end in meetings:
            ...
            if free_rooms:
                ...
                actual_start = end_time  # Must wait until this room is free

            count[room] += 1
            heapq.heappush(used_rooms, (actual_start + duration, room))
