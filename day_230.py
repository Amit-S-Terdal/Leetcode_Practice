...
class FoodRatings(object):
    ...
    def __init__(self, foods, cuisines, ratings):
        ...
        """
        # Initialize the dictionaries for storing food-to-cuisine, food-to-rating, and cuisine-to-food heap.
    ...
    def changeRating(self, food, newRating):
        ...
        :rtype: None
        """
        # Update the rating of the given food
