...
class Solution {
    public int[] queryResults(int limit, int[][] queries) {
        Map<Integer, Integer> ballColors = new HashMap<>(); // Tracks color assigned to each ball
        ...
        for (int[] query : queries) {
            ...
            if (ballColors.containsKey(ball)) {
                ...
                if (colorCount.get(oldColor) == 0) {
                    ...
                    distinctColorCount--; // Remove old color if no balls have it
                }
            }
